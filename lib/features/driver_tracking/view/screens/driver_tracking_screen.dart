...
import 'package:diary_management/features/driver_tracking/view/widgets/driver_stores_list.dart';
import 'package:diary_management/features/driver_tracking/view/widgets/map_with_polylin_widget.dart';
// import 'package:diary_management/features/driver_tracking/view/widgets/store_visit_data_box.dart';
...
class DriverNavigationScreen extends StatelessWidget {
  ...
  final String? dName;
  final String? dPass;
  const DriverNavigationScreen({super.key,  this.driver, this.dName, this.dPass});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create:
          (context) =>
              NavigationBloc()..add(NavigationEvent.fetchRoutes(driver?.id ?? driver2?.id ?? '')),
      child: Scaffold(
        appBar: CustomAppBar(
              ...
              loaded: (currentLocation, polylines, markers, stores) {
                ...
                return Column(
                  children: [
                    ...
                    DriverStoresList(driver: driver?? driver2!, stores: stores),
                  ],
                );
              },
